...
import { X, MapPin, Calendar, Building2, Clock } from "lucide-react";

interface Job {
  id: string; // Matches the database schema
  title: string | null;
  company: string | null; // Adjusted to allow null
  location: string | null; // Adjusted to allow null
  salary: string | null; // Adjusted to allow null
  postedDate: string;
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          {job.deadline && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-4">
              ...
              <p className="text-red-800 font-medium">{job.deadline}</p>
            </div>
          )}
