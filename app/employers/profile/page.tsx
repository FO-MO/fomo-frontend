      ...
      const data: ProfileData = {
        ...
        initials: employerInfo.name
          ? employerInfo.name
              ...
              .slice(0, 2)
          : 'CO',
        backgroundImageUrl: employerInfo.backgroundImg?.url
          ? `${BACKEND_URL}${employerInfo.backgroundImg.url}`
          : null,
        profileImageUrl: employerInfo.profilePic?.url
          ? `${BACKEND_URL}${employerInfo.profilePic.url}`
          : null,
