      ...
      const data = {
        ...
        initials: employerInfo.name
          ? employerInfo.name
              ...
              .slice(0, 2)
          : "CO",
        backgroundImageUrl: employerInfo.backgroundImageUrl || null,
        profileImageUrl: employerInfo.profileImageUrl || null,
      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Specialties */}
            {profileData.specialties && profileData.specialties !== "Not specified" && (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <div className="space-y-4">
                {/* Email */}
                {profileData.email && profileData.email !== "company@example.com" && (
                ...
                {/* Website */}
                {profileData.website && profileData.website !== "Not specified" && (
                  <div className="flex items-center gap-3">
