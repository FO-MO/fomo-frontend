      ...
      <main className="sm:ml-56 pt-20 p-8">
        ...
        <div className="p-8">
            <div className="flex justify-between items-center mb-6">
                ...
                <button className="px-4 py-2 bg-teal-600 text-white rounded-md hover:bg-teal-700">Create Event</button>
                </div>
            </div>

            <div className="flex flex-wrap gap-6 justify-center">
                <WorkshopCard title="AI Bootcamp" type="Technical" />
                <WorkshopCard title="Soft Skills Training" type="Non-Technical" />
                <WorkshopCard title="Entrepreneurship 101" type="Business" />
            </div>
